...
<head>
    ...
    <meta name="description" content="Extend your VPS expiration date">
    <title>Renew VPS - FallenNodes</title>
    <link href="../dist/css/robust.css" rel="stylesheet">
	<script src="../dist/js/jquery.js"></script>
    <script src="https://js.hcaptcha.com/1/api.js"></script>
    <script type="text/javascript" src="../dist/js/renew-vps.js%3Fv=1.1"></script>		
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav ml-auto">		
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php">Renew VPS</a>
                </li>					
...
<div class="container text-center">
	...
	<a href="index.html" class="text-primary">Extend VPS</a> | 
...
<p>You can renew your VPS at least 3 days before it expires </p>
...
<div class="clearfix"></div>								<div id="response"></div>
									<form action="index.html" method="POST" class="submit" id="form-submit">
									  <div class="form-group">
										<label>Please type here our website address without https:// </label>
										<input type="text" name="web_address" class="form-control" id="web_address" placeholder="FallenNodes" required="required">
									  </div>	
									  <div class="form-group row">
										<div class="col-sm-3">
<img src='../img/temp/d7e91f5a4ab48590d898e37421120d3a-954.155.92.21.jpg' >X<img src='../img/temp/acd6acf3c2211169c808efabb7bdd041-554.155.92.21.jpg' >=										</div>
										<div class="col-sm-2">
										  ...
										  <div class="col-sm-12">
											<div class="form-check">
											  ...
											  <label class="form-check-label">
												Please Renew my server and keep my data
											  </label>
											</div>
										  </div>											
										</div>
...
<div class="clearfix"></div>									
									   <button name="submit_button" type="button" class="btn btn-primary">Renew VPS</button>
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- horizontal -->
<ins class="adsbygoogle"
     style="display:block"
...
<div class="container">
<div class="text-center">
<div>VPS is only valid for 7 days but you can renew anytime as long as you need it - <a href="index.html" class="btn btn-info">RENEW</a></div>
</div>
</div>
