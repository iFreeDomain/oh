...
<head>
    ...
    <meta name="description" content="Free Nat VPS for those interested in learning Linux and server">
    <meta name="author" content="FallenNodes">
    <title>Free Nat VPS - FallenNodes</title> 
...
<div class="container text-center">
    ...
    <div class="bg-white py-5">
        ...
        <div class="text-center mb-5">
          <h3 class="text-primary">if IP address doesn't matter then our service is for you </h3>
		  <p class="h3 font-weight-normal mt-3 mb-4">Hosting Telegram Bot, WhatsApp Bot, Python Scripts, Web Server, Learning Linux Server, and Exploring with Nat VPS</p>
        </div>
                    ...
                    <div class="row">
						<div class="col-sm">
							<div class="card h-100 bg-dark text-white">
								<div class="card-body">
								  <h5 class="card-title mb-4">./Free Nat VPS</h5>
								  <p class="card-text">Get Virtual Servers provisioned and running in minutes</p>
								  <a href="create-vps/index.html" class="card-link btn btn-primary">Create VPS</a>
								</div>
							</div>
						</div>
						<div class="col-sm">
							<div class="card h-100">
								<div class="card-body h-100 bg-dark text-white">
								  <h5 class="card-title">./Web Panel</h5>
								  <p class="card-text">Manage your server anywhere, you can reinstall, monitor VPS usage or reset password</p>
								   <a href="vps-status/index.html" class="card-link btn btn-primary">VPS Status</a>
								</div>
							</div>
						</div>
						<div class="col-sm">
							<div class="card h-100">
								<div class="card-body h-100 bg-dark text-white">
								  <h5 class="card-title  mb-4">./Renewable</h5>
								  <p class="card-text">Extend your server duration to keep your free server online</p>
								   <a href="vps-renew/index.html" class="card-link btn btn-primary">Renew VPS</a>
								</div>
							</div>
						</div>
                    </div><!-- /.row -->
